...
class xt_facebook_widget extends WP_Widget {
    function xt_facebook_widget() {
        $widget_ops = array('classname' => 'xt_facebook', 'description' => __('Widget to display a Facebook likebox in your sidebar', 'xt'));
        $this->WP_Widget('xt_facebook', __('XT Facebook Likebox', 'xt'), $widget_ops);
    }
    ...
    function form($instance) {
        $defaults = array('title' => __('Connect with us on Facebook', 'xt'), 'facebook_url' => 'https://www.facebook.com/xtthemes', 'width' => '300', 'height' => '190', 'faces' => true, 'stream' => false, 'header' => false, 'border' => false);
        ...
        <p>
	   		<label for="<?php echo $this->get_field_id('facebook_url'); ?>"><?php _e('Facebook Page URL:', 'xt'); ?></label>
        ...
        <p>
	    	<label for="<?php echo $this->get_field_id('width'); ?>"><?php _e('Width:', 'xt'); ?></label>
	    ...
	    <p>
	    	<label for="<?php echo $this->get_field_id('height'); ?>"><?php _e('Height:', 'xt'); ?></label>
	    ...
	    <p>
	  		...
	  		<label for="<?php echo $this->get_field_id('faces'); ?>"><?php _e('Show Faces', 'xt'); ?></label>
    	</p> 
    	<p>
	  		...
	  		<label for="<?php echo $this->get_field_id('stream'); ?>"><?php _e('Show Stream', 'xt'); ?></label>
    	</p> 	
    	<p>
	  		...
	  		<label for="<?php echo $this->get_field_id('header'); ?>"><?php _e('Show Header', 'xt'); ?></label>
    	</p>     
	    <p>
	  		...
	  		<label for="<?php echo $this->get_field_id('border'); ?>"><?php _e('Show Border', 'xt'); ?></label>
    	</p><?php    
    }
}
